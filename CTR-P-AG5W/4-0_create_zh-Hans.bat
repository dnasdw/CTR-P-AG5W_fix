...
REM tools\3dstool -cvt017f cci build\0.cxi build\1.cfa build\7.cfa "Paper Mario - Sticker Star (TWN) (zh-Hans).3ds" --header cci\ncsdheader.bin
tools\3dstool -cvt017f cci build\0.cxi cci\1.cfa cci\7.cfa "Paper Mario - Sticker Star (TWN) (zh-Hans).3ds" --header cci\ncsdheader.bin
IF NOT "%~1"=="" (
